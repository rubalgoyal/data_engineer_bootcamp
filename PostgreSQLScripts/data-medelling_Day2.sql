--Day2 Lab
-- First Dropped that player table becasuse we needed to add is_Active in players table 
-- DROP TABLE players
/*
...
WITH last_season_scd AS (
	...
	unchanged_records AS(
		...
		changed_records AS (
			...
			ON ls.player_name = ts.player_name
			WHERE (ts.scoring_class <> ts.scoring_class)
				OR (ts.is_active <> ts.is_active)
