...
-- SELECT MIN(season) FROM player_seasons; output 1996

--cummulation between today's and yesterday
-- pipeline created as insert statement 
-- INSERT INTO players
-- WITH yesterday AS(
-- 	SELECT * FROM players
...
-- After dropping table, We created scoring in players table with the old columns
